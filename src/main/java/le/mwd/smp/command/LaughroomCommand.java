...
public class LaughroomCommand {
	...
	public static void registerCommands(RegisterCommandsEvent event) {
		event.getDispatcher().register(LiteralArgumentBuilder.<CommandSource>literal("laughroom").requires(s -> s.hasPermissionLevel(4))
				.then(Commands.literal("set").then(Commands.argument("name", BlockPosArgument.blockPos()).executes(arguments -> {
