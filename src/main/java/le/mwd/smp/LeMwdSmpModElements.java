...
public class LeMwdSmpModElements {
	...
	public LeMwdSmpModElements() {
		...
		try {
			...
			for (ModFileScanData.AnnotationData annotationData : annotations) {
				if (annotationData.getAnnotationType().getClassName().equals(ModElement.Tag.class.getName())) {
					...
					if (clazz.getSuperclass() == LeMwdSmpModElements.ModElement.class)
						elements.add((LeMwdSmpModElements.ModElement) clazz.getConstructor(this.getClass()).newInstance(this));
				}
			}
		} catch (Exception e) {
			e.printStackTrace();
		...
		elements.forEach(LeMwdSmpModElements.ModElement::initElements);
		MinecraftForge.EVENT_BUS.register(new LeMwdSmpModVariables(this));
	}
	...
	public <T> void addNetworkMessage(Class<T> messageType, BiConsumer<T, PacketBuffer> encoder, Function<PacketBuffer, T> decoder,
		...
		LeMwdSmpMod.PACKET_HANDLER.registerMessage(messageID, messageType, encoder, decoder, messageConsumer);
		messageID++;
	}
	...
	public static class ModElement implements Comparable<ModElement> {
		...
		protected final LeMwdSmpModElements elements;
		protected final int sortid;

		public ModElement(LeMwdSmpModElements elements, int sortid) {
