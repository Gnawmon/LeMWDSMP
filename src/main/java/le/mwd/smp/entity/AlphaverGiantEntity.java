...
public class AlphaverGiantEntity extends LeMwdSmpModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).size(3f, 12f))
			.build("alphaver_giant").setRegistryName("alphaver_giant");

	public AlphaverGiantEntity(LeMwdSmpModElements instance) {
		super(instance, 290);
		FMLJavaModLoadingContext.get().getModEventBus().register(new AlphaverGiantRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items
				.add(() -> new SpawnEggItem(entity, -1, -1, new Item.Properties().group(ItemGroup.MISC)).setRegistryName("alphaver_giant_spawn_egg"));
	}
	...
	public static class CustomEntity extends MonsterEntity {
		...
		protected void dropSpecialItems(DamageSource source, int looting, boolean recentlyHitIn) {
			...
			this.entityDropItem(new ItemStack(FlamebergeShardItem.block));
		}
