...
@OnlyIn(Dist.CLIENT)
public class HamilRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(HamilEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new Modelplayer(), 0.5f) {

					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("le_mwd_smp:textures/entities/hamilopie.png");
					}
				};
			});
		}
