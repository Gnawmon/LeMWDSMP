...
public class BlackPillar2Block extends LeMwdSmpModElements.ModElement {
	@ObjectHolder("le_mwd_smp:black_pillar_2")
	public static final Block block = null;

	public BlackPillar2Block(LeMwdSmpModElements instance) {
		super(instance, 120);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("black_pillar_2");
		}
