...
public class HallowedBricksBlock extends LeMwdSmpModElements.ModElement {
	@ObjectHolder("le_mwd_smp:hallowed_bricks")
	public static final Block block = null;

	public HallowedBricksBlock(LeMwdSmpModElements instance) {
		super(instance, 217);
	}
