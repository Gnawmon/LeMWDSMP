...
public class SaltTilesBlock extends LeMwdSmpModElements.ModElement {
	@ObjectHolder("le_mwd_smp:salt_tiles")
	public static final Block block = null;

	public SaltTilesBlock(LeMwdSmpModElements instance) {
		super(instance, 173);
	}
