...
public class SaltBrickSlabBlock extends LeMwdSmpModElements.ModElement {
	@ObjectHolder("le_mwd_smp:salt_brick_slab")
	public static final Block block = null;

	public SaltBrickSlabBlock(LeMwdSmpModElements instance) {
		super(instance, 164);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("salt_brick_slab");
		}
