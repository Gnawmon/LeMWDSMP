...
public class HubFloorBlock extends LeMwdSmpModElements.ModElement {
	@ObjectHolder("le_mwd_smp:hub_floor")
	public static final Block block = null;

	public HubFloorBlock(LeMwdSmpModElements instance) {
		super(instance, 306);
	}
