...
public class Slaize80Block extends LeMwdSmpModElements.ModElement {
	@ObjectHolder("le_mwd_smp:slaize_80")
	public static final Block block = null;

	public Slaize80Block(LeMwdSmpModElements instance) {
		super(instance, 73);
	}
