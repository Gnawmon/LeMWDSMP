...
public class PsiBlockBlock extends LeMwdSmpModElements.ModElement {
	@ObjectHolder("le_mwd_smp:psi_block")
	public static final Block block = null;

	public PsiBlockBlock(LeMwdSmpModElements instance) {
		super(instance, 39);
	}
