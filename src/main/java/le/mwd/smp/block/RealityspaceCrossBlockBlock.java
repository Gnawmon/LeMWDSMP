...
public class RealityspaceCrossBlockBlock extends LeMwdSmpModElements.ModElement {
	@ObjectHolder("le_mwd_smp:realityspace_cross_block")
	public static final Block block = null;

	public RealityspaceCrossBlockBlock(LeMwdSmpModElements instance) {
		super(instance, 207);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("realityspace_cross_block");
		}
