...
public class DooDooGreenBricksBlock extends LeMwdSmpModElements.ModElement {
	@ObjectHolder("le_mwd_smp:doo_doo_green_bricks")
	public static final Block block = null;

	public DooDooGreenBricksBlock(LeMwdSmpModElements instance) {
		super(instance, 332);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("doo_doo_green_bricks");
		}
