...
public class Wall6Block extends LeMwdSmpModElements.ModElement {
	@ObjectHolder("le_mwd_smp:wall_6")
	public static final Block block = null;

	public Wall6Block(LeMwdSmpModElements instance) {
		super(instance, 19);
	}
