...
public class Wall4Block extends LeMwdSmpModElements.ModElement {
	@ObjectHolder("le_mwd_smp:wall_4")
	public static final Block block = null;

	public Wall4Block(LeMwdSmpModElements instance) {
		super(instance, 17);
	}
