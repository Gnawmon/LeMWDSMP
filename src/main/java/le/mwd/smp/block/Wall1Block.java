...
import le.mwd.smp.gui.MoonfallterminalGui;
...
public class Wall1Block extends LeMwdSmpModElements.ModElement {
	@ObjectHolder("le_mwd_smp:wall_1")
	public static final Block block = null;

	public Wall1Block(LeMwdSmpModElements instance) {
		super(instance, 14);
	}
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("Wall 1");
					}

					@Override
					public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
						return new MoonfallterminalGui.GuiContainerMod(id, inventory,
