...
public class ChiseledSaltBlockBlock extends LeMwdSmpModElements.ModElement {
	@ObjectHolder("le_mwd_smp:chiseled_salt_block")
	public static final Block block = null;

	public ChiseledSaltBlockBlock(LeMwdSmpModElements instance) {
		super(instance, 181);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("chiseled_salt_block");
		}
