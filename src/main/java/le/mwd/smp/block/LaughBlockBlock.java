...
public class LaughBlockBlock extends LeMwdSmpModElements.ModElement {
	@ObjectHolder("le_mwd_smp:laugh_block")
	public static final Block block = null;

	public LaughBlockBlock(LeMwdSmpModElements instance) {
		super(instance, 51);
	}
