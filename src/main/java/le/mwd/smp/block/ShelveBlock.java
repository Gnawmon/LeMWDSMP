...
public class ShelveBlock extends LeMwdSmpModElements.ModElement {
	@ObjectHolder("le_mwd_smp:shelve")
	public static final Block block = null;

	public ShelveBlock(LeMwdSmpModElements instance) {
		super(instance, 64);
	}
