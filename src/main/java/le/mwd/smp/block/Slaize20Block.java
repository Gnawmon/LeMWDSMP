...
public class Slaize20Block extends LeMwdSmpModElements.ModElement {
	@ObjectHolder("le_mwd_smp:slaize_20")
	public static final Block block = null;

	public Slaize20Block(LeMwdSmpModElements instance) {
		super(instance, 67);
	}
