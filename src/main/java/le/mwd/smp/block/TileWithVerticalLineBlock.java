...
public class TileWithVerticalLineBlock extends LeMwdSmpModElements.ModElement {
	@ObjectHolder("le_mwd_smp:tile_with_vertical_line")
	public static final Block block = null;

	public TileWithVerticalLineBlock(LeMwdSmpModElements instance) {
		super(instance, 77);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("tile_with_vertical_line");
		}
