...
public class Wall5Block extends LeMwdSmpModElements.ModElement {
	@ObjectHolder("le_mwd_smp:wall_5")
	public static final Block block = null;

	public Wall5Block(LeMwdSmpModElements instance) {
		super(instance, 18);
	}
