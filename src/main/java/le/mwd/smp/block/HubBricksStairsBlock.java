...
public class HubBricksStairsBlock extends LeMwdSmpModElements.ModElement {
	@ObjectHolder("le_mwd_smp:hub_bricks_stairs")
	public static final Block block = null;

	public HubBricksStairsBlock(LeMwdSmpModElements instance) {
		super(instance, 302);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("hub_bricks_stairs");
		}
