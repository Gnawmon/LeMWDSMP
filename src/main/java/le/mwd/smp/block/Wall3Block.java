...
public class Wall3Block extends LeMwdSmpModElements.ModElement {
	@ObjectHolder("le_mwd_smp:wall_3")
	public static final Block block = null;

	public Wall3Block(LeMwdSmpModElements instance) {
		super(instance, 16);
	}
