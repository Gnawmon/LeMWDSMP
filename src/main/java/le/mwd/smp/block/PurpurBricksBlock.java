...
public class PurpurBricksBlock extends LeMwdSmpModElements.ModElement {
	@ObjectHolder("le_mwd_smp:purpur_bricks")
	public static final Block block = null;

	public PurpurBricksBlock(LeMwdSmpModElements instance) {
		super(instance, 201);
	}
