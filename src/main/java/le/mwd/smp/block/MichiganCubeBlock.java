...
public class MichiganCubeBlock extends LeMwdSmpModElements.ModElement {
	@ObjectHolder("le_mwd_smp:michigan_cube")
	public static final Block block = null;

	public MichiganCubeBlock(LeMwdSmpModElements instance) {
		super(instance, 127);
	}
