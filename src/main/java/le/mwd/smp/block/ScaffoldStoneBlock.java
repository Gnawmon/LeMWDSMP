...
public class ScaffoldStoneBlock extends LeMwdSmpModElements.ModElement {
	@ObjectHolder("le_mwd_smp:scaffold_stone")
	public static final Block block = null;

	public ScaffoldStoneBlock(LeMwdSmpModElements instance) {
		super(instance, 159);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("scaffold_stone");
		}
