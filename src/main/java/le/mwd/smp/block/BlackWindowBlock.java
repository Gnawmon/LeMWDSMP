...
public class BlackWindowBlock extends LeMwdSmpModElements.ModElement {
	@ObjectHolder("le_mwd_smp:black_window")
	public static final Block block = null;

	public BlackWindowBlock(LeMwdSmpModElements instance) {
		super(instance, 49);
	}
