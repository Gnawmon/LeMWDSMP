...
public class SaltBricksBlock extends LeMwdSmpModElements.ModElement {
	@ObjectHolder("le_mwd_smp:salt_bricks")
	public static final Block block = null;

	public SaltBricksBlock(LeMwdSmpModElements instance) {
		super(instance, 161);
	}
