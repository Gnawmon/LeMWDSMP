...
public class MineWatchCameraBlock extends LeMwdSmpModElements.ModElement {
	@ObjectHolder("le_mwd_smp:mine_watch_camera")
	public static final Block block = null;

	public MineWatchCameraBlock(LeMwdSmpModElements instance) {
		super(instance, 218);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("mine_watch_camera");
		}
