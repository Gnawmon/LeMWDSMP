...
public class AlphaverCatCubeBlock extends LeMwdSmpModElements.ModElement {
	@ObjectHolder("le_mwd_smp:alphaver_cat_cube")
	public static final Block block = null;

	public AlphaverCatCubeBlock(LeMwdSmpModElements instance) {
		super(instance, 126);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("alphaver_cat_cube");
		}
