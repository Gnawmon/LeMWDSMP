...
public class Slaize00Block extends LeMwdSmpModElements.ModElement {
	@ObjectHolder("le_mwd_smp:slaize_00")
	public static final Block block = null;

	public Slaize00Block(LeMwdSmpModElements instance) {
		super(instance, 65);
	}
