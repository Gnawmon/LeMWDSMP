...
public class RealityspaceMsPacmanBlockBlock extends LeMwdSmpModElements.ModElement {
	@ObjectHolder("le_mwd_smp:realityspace_ms_pacman_block")
	public static final Block block = null;

	public RealityspaceMsPacmanBlockBlock(LeMwdSmpModElements instance) {
		super(instance, 203);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("realityspace_ms_pacman_block");
		}
