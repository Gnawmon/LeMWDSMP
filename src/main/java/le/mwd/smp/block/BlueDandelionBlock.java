...
public class BlueDandelionBlock extends LeMwdSmpModElements.ModElement {
	@ObjectHolder("le_mwd_smp:blue_dandelion")
	public static final Block block = null;

	public BlueDandelionBlock(LeMwdSmpModElements instance) {
		super(instance, 200);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("blue_dandelion");
		}
