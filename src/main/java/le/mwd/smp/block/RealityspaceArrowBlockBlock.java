...
public class RealityspaceArrowBlockBlock extends LeMwdSmpModElements.ModElement {
	@ObjectHolder("le_mwd_smp:realityspace_arrow_block")
	public static final Block block = null;

	public RealityspaceArrowBlockBlock(LeMwdSmpModElements instance) {
		super(instance, 202);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("realityspace_arrow_block");
		}
