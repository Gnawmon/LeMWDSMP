...
public class MojangBlockBlock extends LeMwdSmpModElements.ModElement {
	@ObjectHolder("le_mwd_smp:mojang_block")
	public static final Block block = null;

	public MojangBlockBlock(LeMwdSmpModElements instance) {
		super(instance, 48);
	}
