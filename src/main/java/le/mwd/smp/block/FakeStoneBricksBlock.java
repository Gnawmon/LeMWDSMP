...
public class FakeStoneBricksBlock extends LeMwdSmpModElements.ModElement {
	@ObjectHolder("le_mwd_smp:fake_stone_bricks")
	public static final Block block = null;

	public FakeStoneBricksBlock(LeMwdSmpModElements instance) {
		super(instance, 163);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("fake_stone_bricks");
		}
