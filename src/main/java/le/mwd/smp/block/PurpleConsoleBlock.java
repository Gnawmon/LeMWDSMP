...
public class PurpleConsoleBlock extends LeMwdSmpModElements.ModElement {
	@ObjectHolder("le_mwd_smp:purple_console")
	public static final Block block = null;

	public PurpleConsoleBlock(LeMwdSmpModElements instance) {
		super(instance, 45);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("purple_console");
		}
