...
public class Slaize50Block extends LeMwdSmpModElements.ModElement {
	@ObjectHolder("le_mwd_smp:slaize_50")
	public static final Block block = null;

	public Slaize50Block(LeMwdSmpModElements instance) {
		super(instance, 70);
	}
