...
public class Drumptoil2Block extends LeMwdSmpModElements.ModElement {
	@ObjectHolder("le_mwd_smp:drumptoil_2")
	public static final Block block = null;

	public Drumptoil2Block(LeMwdSmpModElements instance) {
		super(instance, 46);
	}
