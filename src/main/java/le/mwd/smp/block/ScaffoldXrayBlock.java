...
public class ScaffoldXrayBlock extends LeMwdSmpModElements.ModElement {
	@ObjectHolder("le_mwd_smp:scaffold_xray")
	public static final Block block = null;

	public ScaffoldXrayBlock(LeMwdSmpModElements instance) {
		super(instance, 158);
	}
