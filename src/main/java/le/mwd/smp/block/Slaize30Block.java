...
public class Slaize30Block extends LeMwdSmpModElements.ModElement {
	@ObjectHolder("le_mwd_smp:slaize_30")
	public static final Block block = null;

	public Slaize30Block(LeMwdSmpModElements instance) {
		super(instance, 68);
	}
