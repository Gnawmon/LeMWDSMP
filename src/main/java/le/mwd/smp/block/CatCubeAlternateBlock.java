...
public class CatCubeAlternateBlock extends LeMwdSmpModElements.ModElement {
	@ObjectHolder("le_mwd_smp:cat_cube_alternate")
	public static final Block block = null;

	public CatCubeAlternateBlock(LeMwdSmpModElements instance) {
		super(instance, 129);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("cat_cube_alternate");
		}
