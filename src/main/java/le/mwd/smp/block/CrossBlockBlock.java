...
public class CrossBlockBlock extends LeMwdSmpModElements.ModElement {
	@ObjectHolder("le_mwd_smp:cross_block")
	public static final Block block = null;

	public CrossBlockBlock(LeMwdSmpModElements instance) {
		super(instance, 40);
	}
