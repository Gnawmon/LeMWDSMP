...
public class Slaize100Block extends LeMwdSmpModElements.ModElement {
	@ObjectHolder("le_mwd_smp:slaize_100")
	public static final Block block = null;

	public Slaize100Block(LeMwdSmpModElements instance) {
		super(instance, 75);
	}
