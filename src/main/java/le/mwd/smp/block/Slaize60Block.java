...
public class Slaize60Block extends LeMwdSmpModElements.ModElement {
	@ObjectHolder("le_mwd_smp:slaize_60")
	public static final Block block = null;

	public Slaize60Block(LeMwdSmpModElements instance) {
		super(instance, 71);
	}
