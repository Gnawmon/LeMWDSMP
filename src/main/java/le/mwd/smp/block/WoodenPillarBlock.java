...
public class WoodenPillarBlock extends LeMwdSmpModElements.ModElement {
	@ObjectHolder("le_mwd_smp:wooden_pillar")
	public static final Block block = null;

	public WoodenPillarBlock(LeMwdSmpModElements instance) {
		super(instance, 92);
	}
