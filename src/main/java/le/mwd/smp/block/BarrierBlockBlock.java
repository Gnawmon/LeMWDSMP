...
public class BarrierBlockBlock extends LeMwdSmpModElements.ModElement {
	@ObjectHolder("le_mwd_smp:barrier_block")
	public static final Block block = null;

	public BarrierBlockBlock(LeMwdSmpModElements instance) {
		super(instance, 151);
	}
