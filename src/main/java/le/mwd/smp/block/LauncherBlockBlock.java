...
public class LauncherBlockBlock extends LeMwdSmpModElements.ModElement {
	@ObjectHolder("le_mwd_smp:launcher_block")
	public static final Block block = null;

	public LauncherBlockBlock(LeMwdSmpModElements instance) {
		super(instance, 145);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("launcher_block");
		}
