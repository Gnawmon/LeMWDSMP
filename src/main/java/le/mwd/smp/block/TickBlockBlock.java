...
public class TickBlockBlock extends LeMwdSmpModElements.ModElement {
	@ObjectHolder("le_mwd_smp:tick_block")
	public static final Block block = null;

	public TickBlockBlock(LeMwdSmpModElements instance) {
		super(instance, 41);
	}
