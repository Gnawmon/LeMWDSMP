...
public class HubBricksSlabBlock extends LeMwdSmpModElements.ModElement {
	@ObjectHolder("le_mwd_smp:hub_bricks_slab")
	public static final Block block = null;

	public HubBricksSlabBlock(LeMwdSmpModElements instance) {
		super(instance, 301);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("hub_bricks_slab");
		}
