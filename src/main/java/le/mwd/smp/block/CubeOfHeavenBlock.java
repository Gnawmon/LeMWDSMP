...
public class CubeOfHeavenBlock extends LeMwdSmpModElements.ModElement {
	@ObjectHolder("le_mwd_smp:cube_of_heaven")
	public static final Block block = null;

	public CubeOfHeavenBlock(LeMwdSmpModElements instance) {
		super(instance, 128);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("cube_of_heaven");
		}
