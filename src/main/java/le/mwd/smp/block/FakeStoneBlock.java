...
public class FakeStoneBlock extends LeMwdSmpModElements.ModElement {
	@ObjectHolder("le_mwd_smp:fake_stone")
	public static final Block block = null;

	public FakeStoneBlock(LeMwdSmpModElements instance) {
		super(instance, 100);
	}
