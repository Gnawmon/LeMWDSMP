...
public class ChiseledHallowedStoneBlock extends LeMwdSmpModElements.ModElement {
	@ObjectHolder("le_mwd_smp:chiseled_hallowed_stone")
	public static final Block block = null;

	public ChiseledHallowedStoneBlock(LeMwdSmpModElements instance) {
		super(instance, 308);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("chiseled_hallowed_stone");
		}
