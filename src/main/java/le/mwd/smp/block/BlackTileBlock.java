...
public class BlackTileBlock extends LeMwdSmpModElements.ModElement {
	@ObjectHolder("le_mwd_smp:black_tile")
	public static final Block block = null;

	public BlackTileBlock(LeMwdSmpModElements instance) {
		super(instance, 34);
	}
