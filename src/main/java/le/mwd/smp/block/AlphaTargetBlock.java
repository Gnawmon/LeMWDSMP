...
public class AlphaTargetBlock extends LeMwdSmpModElements.ModElement {
	@ObjectHolder("le_mwd_smp:alpha_target")
	public static final Block block = null;

	public AlphaTargetBlock(LeMwdSmpModElements instance) {
		super(instance, 290);
	}
