...
public class FlowerBlock extends LeMwdSmpModElements.ModElement {
	@ObjectHolder("le_mwd_smp:flower")
	public static final Block block = null;

	public FlowerBlock(LeMwdSmpModElements instance) {
		super(instance, 83);
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public CustomBlock() {
			super(Block.Properties.create(Material.PLANTS).sound(SoundType.PLANT).hardnessAndResistance(0f, 0f).setLightLevel(s -> 12)
		...
		public ActionResultType onBlockActivated(BlockState blockstate, World world, BlockPos pos, PlayerEntity entity, Hand hand,
			...
			FlowerInfuseProcedure.executeProcedure(Stream
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("le_mwd_smp:flower_match"), () -> CustomRuleTest.codec);
