...
public class BlackLightBlock extends LeMwdSmpModElements.ModElement {
	@ObjectHolder("le_mwd_smp:black_light")
	public static final Block block = null;

	public BlackLightBlock(LeMwdSmpModElements instance) {
		super(instance, 121);
	}
