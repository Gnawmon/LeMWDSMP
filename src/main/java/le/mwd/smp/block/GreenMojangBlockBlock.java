...
public class GreenMojangBlockBlock extends LeMwdSmpModElements.ModElement {
	@ObjectHolder("le_mwd_smp:green_mojang_block")
	public static final Block block = null;

	public GreenMojangBlockBlock(LeMwdSmpModElements instance) {
		super(instance, 142);
	}
