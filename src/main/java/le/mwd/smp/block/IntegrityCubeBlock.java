...
public class IntegrityCubeBlock extends LeMwdSmpModElements.ModElement {
	@ObjectHolder("le_mwd_smp:integrity_cube")
	public static final Block block = null;

	public IntegrityCubeBlock(LeMwdSmpModElements instance) {
		super(instance, 125);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("integrity_cube");
		}
