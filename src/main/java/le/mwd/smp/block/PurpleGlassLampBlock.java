...
public class PurpleGlassLampBlock extends LeMwdSmpModElements.ModElement {
	@ObjectHolder("le_mwd_smp:purple_glass_lamp")
	public static final Block block = null;

	public PurpleGlassLampBlock(LeMwdSmpModElements instance) {
		super(instance, 245);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("purple_glass_lamp");
		}
