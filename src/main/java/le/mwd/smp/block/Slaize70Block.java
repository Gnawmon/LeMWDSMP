...
public class Slaize70Block extends LeMwdSmpModElements.ModElement {
	@ObjectHolder("le_mwd_smp:slaize_70")
	public static final Block block = null;

	public Slaize70Block(LeMwdSmpModElements instance) {
		super(instance, 72);
	}
