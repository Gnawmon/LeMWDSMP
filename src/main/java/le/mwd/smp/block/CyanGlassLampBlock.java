...
public class CyanGlassLampBlock extends LeMwdSmpModElements.ModElement {
	@ObjectHolder("le_mwd_smp:cyan_glass_lamp")
	public static final Block block = null;

	public CyanGlassLampBlock(LeMwdSmpModElements instance) {
		super(instance, 243);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("cyan_glass_lamp");
		}
