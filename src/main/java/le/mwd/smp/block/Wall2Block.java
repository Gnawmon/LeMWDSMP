...
public class Wall2Block extends LeMwdSmpModElements.ModElement {
	@ObjectHolder("le_mwd_smp:wall_2")
	public static final Block block = null;

	public Wall2Block(LeMwdSmpModElements instance) {
		super(instance, 15);
	}
