...
public class RealityspaceTileBlockBlock extends LeMwdSmpModElements.ModElement {
	@ObjectHolder("le_mwd_smp:realityspace_tile_block")
	public static final Block block = null;

	public RealityspaceTileBlockBlock(LeMwdSmpModElements instance) {
		super(instance, 206);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("realityspace_tile_block");
		}
