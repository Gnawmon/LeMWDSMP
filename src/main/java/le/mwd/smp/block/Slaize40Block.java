...
public class Slaize40Block extends LeMwdSmpModElements.ModElement {
	@ObjectHolder("le_mwd_smp:slaize_40")
	public static final Block block = null;

	public Slaize40Block(LeMwdSmpModElements instance) {
		super(instance, 69);
	}
