...
public class YellowTileBlock extends LeMwdSmpModElements.ModElement {
	@ObjectHolder("le_mwd_smp:yellow_tile")
	public static final Block block = null;

	public YellowTileBlock(LeMwdSmpModElements instance) {
		super(instance, 140);
	}
