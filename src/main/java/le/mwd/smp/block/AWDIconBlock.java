...
public class AWDIconBlock extends LeMwdSmpModElements.ModElement {
	@ObjectHolder("le_mwd_smp:awd_icon")
	public static final Block block = null;

	public AWDIconBlock(LeMwdSmpModElements instance) {
		super(instance, 221);
	}
	...
	public static class CustomBlock extends Block {
		...
		public VoxelShape getShape(BlockState state, IBlockReader world, BlockPos pos, ISelectionContext context) {
			...
			return VoxelShapes.or(makeCuboidShape(3, 0, 2, 13, 14, 13))
