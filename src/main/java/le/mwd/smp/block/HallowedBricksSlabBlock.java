...
public class HallowedBricksSlabBlock extends LeMwdSmpModElements.ModElement {
	@ObjectHolder("le_mwd_smp:hallowed_bricks_slab")
	public static final Block block = null;

	public HallowedBricksSlabBlock(LeMwdSmpModElements instance) {
		super(instance, 309);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("hallowed_bricks_slab");
		}
