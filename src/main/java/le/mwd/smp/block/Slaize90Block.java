...
public class Slaize90Block extends LeMwdSmpModElements.ModElement {
	@ObjectHolder("le_mwd_smp:slaize_90")
	public static final Block block = null;

	public Slaize90Block(LeMwdSmpModElements instance) {
		super(instance, 74);
	}
