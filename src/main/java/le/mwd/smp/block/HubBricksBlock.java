...
public class HubBricksBlock extends LeMwdSmpModElements.ModElement {
	@ObjectHolder("le_mwd_smp:hub_bricks")
	public static final Block block = null;

	public HubBricksBlock(LeMwdSmpModElements instance) {
		super(instance, 230);
	}
