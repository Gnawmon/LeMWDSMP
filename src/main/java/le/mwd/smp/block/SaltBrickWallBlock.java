...
public class SaltBrickWallBlock extends LeMwdSmpModElements.ModElement {
	@ObjectHolder("le_mwd_smp:salt_brick_wall")
	public static final Block block = null;

	public SaltBrickWallBlock(LeMwdSmpModElements instance) {
		super(instance, 166);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("salt_brick_wall");
		}
