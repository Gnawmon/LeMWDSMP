...
public class ChainBlockBlock extends LeMwdSmpModElements.ModElement {
	@ObjectHolder("le_mwd_smp:chain_block")
	public static final Block block = null;

	public ChainBlockBlock(LeMwdSmpModElements instance) {
		super(instance, 21);
	}
