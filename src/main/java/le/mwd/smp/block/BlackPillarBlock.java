...
public class BlackPillarBlock extends LeMwdSmpModElements.ModElement {
	@ObjectHolder("le_mwd_smp:black_pillar")
	public static final Block block = null;

	public BlackPillarBlock(LeMwdSmpModElements instance) {
		super(instance, 118);
	}
