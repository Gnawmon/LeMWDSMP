...
public class ArgFansBlock extends LeMwdSmpModElements.ModElement {
	@ObjectHolder("le_mwd_smp:arg_fans")
	public static final Block block = null;

	public ArgFansBlock(LeMwdSmpModElements instance) {
		super(instance, 130);
	}
