...
public class Slaize10Block extends LeMwdSmpModElements.ModElement {
	@ObjectHolder("le_mwd_smp:slaize_10")
	public static final Block block = null;

	public Slaize10Block(LeMwdSmpModElements instance) {
		super(instance, 66);
	}
