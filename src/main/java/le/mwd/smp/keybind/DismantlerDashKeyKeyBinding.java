...
public class DismantlerDashKeyKeyBinding extends LeMwdSmpModElements.ModElement {
	...
	public void initElements() {
		keys = new KeyBinding("key.le_mwd_smp.dismantler_dash_key", GLFW.GLFW_KEY_Z, "key.categories.movement");
	...
	private static void pressAction(PlayerEntity entity, int type, int pressedms) {
		...
		if (type == 1) {
			...
			DismantlerDashKeyOnKeyReleasedProcedure.executeProcedure(Stream
