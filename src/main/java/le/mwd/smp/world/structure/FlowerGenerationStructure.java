...
public class FlowerGenerationStructure {
	...
	private static class FeatureRegisterHandler {
		...
		public static void registerFeature(RegistryEvent.Register<Feature<?>> event) {
					...
					if ((random.nextInt(1000000) + 1) <= 15000) {
						...
						for (int a = 0; a < count; a++) {
							...
							Template template = world.getWorld().getStructureTemplateManager()
									.getTemplateDefaulted(new ResourceLocation("le_mwd_smp", "flower"));
							if (template == null)
								return false;
			...
			event.getRegistry().register(feature.setRegistryName("flower_generation"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("le_mwd_smp:flower_generation"), configuredFeature);
		}
	}
