...
public class AndrewWellStructure {
	...
	private static class FeatureRegisterHandler {
		...
		public static void registerFeature(RegistryEvent.Register<Feature<?>> event) {
					...
					if ((random.nextInt(1000000) + 1) <= 5000) {
						...
						for (int a = 0; a < count; a++) {
							...
							Template template = world.getWorld().getStructureTemplateManager()
									.getTemplateDefaulted(new ResourceLocation("le_mwd_smp", "andrew_well"));
							if (template == null)
								return false;
			...
			event.getRegistry().register(feature.setRegistryName("andrew_well"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("le_mwd_smp:andrew_well"), configuredFeature);
		}
	}
